...
public class JDBC2 {
    private static Logger logger = LogManager.getLogger(JDBC2.class.getName());
    ...
    ArrayList<Timestamp> arr1=new ArrayList<Timestamp>();
    ArrayList<Timestamp> arr2=new ArrayList<Timestamp>();
    ArrayList<Integer> sfxf = new ArrayList<Integer>();
